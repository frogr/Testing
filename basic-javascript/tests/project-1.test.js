...
describe('Project-1 Function', () => {
  describe('`multiplyByTen`', () => {
    ...
    // begin here
    it('should return 100 with input 10', () => {
      const multiplyByTen = funcs.multiplyByTen;
      const expectedProduct = 100;
      const product = multiplyByTen(10);

      expect(multiplyByTen(10)).to.equal(100);
    });
    it('should return 50 with input 5', () => {
      const multiplyByTen = funcs.multiplyByTen;
  ...
  describe('`subtractFive`', () => {
    ...
    it('should return 5 when given 10', () => {
      ...
      const difference = subtractFive(10);

      expect(subtractFive(10)).to.equal(5);
      expect(subtractFive(10)).to.be.a('number');
    });
    it('should return a number', () => {
      const subtractFive = funcs.multiplyByTen;

      expect(subtractFive(10)).to.be.a('number');
      expect(subtractFive(100)).to.be.a('number');
    });
  });
